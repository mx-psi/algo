...
Todos los tiempos que se muestran en las tablas están en segundos, mientras que el tamaño menciona el tamaño total de la muestra con la que se trabajaba. En los algoritmos de ordenación hace referencia a la capacidad del vector que se ordenaba, mientras que en Fibonacci o Hanoi hace referencia a las iteraciones totales del programa. 

Debido al tamaño tan grande de las tablas (ya que cada una debía tener al menos 25 puntos), cada tabla se muestra en una página.
...
\begin{figure}[h] \includegraphics[width=10cm]{comparativa_cuadraticos_g} \centering
	\caption{Algoritmos cuadráticos} \end{figure}
Comentarios

\subsection{Gráfica de los algoritmos $n\cdot log(n)$ }
\begin{figure}[h] \includegraphics[width=10cm]{comparativa_logaritmicos} \centering
	\caption{Algoritmos  $n\cdot log(n)$} \end{figure}
Más comentarios

\newpage
\subsection{Gráfica del algoritmo de Floyd (cúbico)}
\begin{figure}[h] \includegraphics[width=10cm]{floyd_g} \centering
...
\begin{figure}[h] \includegraphics[width=10cm]{fibonacci_g} \centering
...
\begin{figure}[h] \includegraphics[width=10cm]{hanoi_g} \centering
...
\begin{figure}[h] \includegraphics[width=10cm]{comparativa_global} \centering
