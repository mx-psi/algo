...
\begin{tabular}{|l|l|l|l|}
  ...
  Darío &$89\cdot10^{-3} -1.61671\cdot10^{-5}\cdot n +3\cdot10^{-9}\cdot n^2$ $ (r=0.9999956782)$ &$89 \cdot 10^{-3}+-1.6166\cdot10^{-5} \cdot n +1.68\cdot 10^{-9}\cdot n^2$ $ (r=0.999999728)$&$89\cdot 10^{-3}-1.616\cdot 10^{-5}\cdot n +1.59 \cdot 10^{-9} \cdot n^2$ $(r=0.9996713117)$ \\
   ...
   \hline
	...
	\hline
	Iñaki & $3.2266\cdot 10^{-9}n^2 +1.35679\cdot 10^{-7}n -2.51574\cdot 10^{-5}$ ($r=0.999996199421436$)
	& $1.16751\cdot 10^{-9}n^2 +1.35677 \cdot 10^{-7}n -2.51574\cdot 10^{-5}$ ($r=0.999921996874859$)
	& $1.31446\cdot 10^{-9}n^2 +5.80581\cdot 10^{-7} -0.0023388$ ($r=0.999998778389281$)\\
	\hline
\end{tabular}
}
...
\begin{tabular}{|l|l|l|l|}
   ...
   \hline
	...
	\hline
	Iñaki & $2.45545\cdot 10^{-8}n\log(n) +1.35661\cdot 10^{-7}$ ($r=0.999638838606578$)
	& $1.47854\cdot 10^{-8}n\log(n) +1$ ($r=0.997502205276852$)
	& $1.12236\cdot 10^{-8}n\log(n) +1.35661\cdot 10^{-7}$ ($r=0.999970810025678$)\\
	\hline
...
\begin{tabular}{|l|l|l|}
 ...
 \hline
 Iñaki & $5.75537\cdot 10^{-9}n^3 +1.35661\cdot 10^{-7}n^2 -2.51574\cdot 10^{-5}n +0.00177757$ & $0.999995066053425$\\
 \hline
...
\begin{tabular}{|l|l|l|}
 ...
 \hline
 Iñaki & $4.29097\cdot 10^{-9} \varphi^n +5.59745\cdot 10^{-6}$ & $0.99483331378377$\\
 \hline
\end{tabular}}
...
\begin{tabular}{|l|l|l|}
 ...
 \hline
 Iñaki & $0.060337 2^n -0.0300806$ & $0.99999327657949$\\
 \hline
\end{tabular}}
