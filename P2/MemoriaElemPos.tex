...
\lstinputlisting[firstline=93, lastline=94]{cpps/posicion.cpp}

%% TODO: (Iñaki) Explicación y comparación del algoritmo
%% TODO: (Iñaki) Párrafo sobre la eficiencia de la versión no recursiva
...
\lstinputlisting[firstline=101, lastline=125]{cpps/posicion.cpp}
